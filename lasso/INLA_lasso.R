...
#data: list with 'y'y and 'x' (matrix of covariates, not including
#intercept)
...
optim(c(0, 1.818961, 0, 0, 4.052350), cond.mlik,
      method = "SANN", data = d)
##----------------------------------------------------------------------
...
#Run simulations
inlamh.res <- INLAMH(
    d, fit.inla, rep(0, n.beta),
    rq.beta, dq.beta, prior.beta,
    n.sim = 1000, n.burnin = 50, n.thin = 5, verbose = TRUE)
